...
const CreateAccount = () => {
  ...
  const {
    ...
    const res = await GetConfigsListFeeAccount();
    return res?.data;
  });
  ...
  const handleDelete = async (id) => {
    if (window.confirm("Are you sure you want to delete?")) {
      try {
        await DeleteConfigsIdFeeAccount(id);
        classRefetch();
      } catch (error) {
              ...
              <Table aria-label="house table">
                <TableHead>
                  <TableRow>
                    ...
                    <StyledTableCell align="left">Fee Account</StyledTableCell>
                    <StyledTableCell align="left">Report Header</StyledTableCell>
