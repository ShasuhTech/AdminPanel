...
import { AddFeeStructure, GetConfigsListFee } from "@/services/api";
...
const FeeStructureTable = () => {
  ...
  const handleSubmit = async () => {
    ...
    const payload = { feeItems: formattedData, feeId: feeGroupSelect };
      ...
      <TableContainer component={Paper}>
        <Table>
          ...
          <TableBody>
                ...
                {["qtr1", "qtr2", "qtr3", "qtr4"].map((quarter) => (
                  <TableCell key={quarter}>
                    <TextField
                      ...
                      value={fee[quarter]}
                      onChange={(e) =>
                        handleAmountChange(index, quarter, e.target.value)
                      }
            ...
            <TableRow>
              <TableCell sx={{ fontWeight: "bold", fontSize: 14 }} colSpan={2}>
                Total
              </TableCell>
              {["qtr1", "qtr2", "qtr3", "qtr4"].map((quarter) => (
                <TableCell key={quarter}>
                  {calculateColumnTotal(quarter)}
                </TableCell>
              ))}
              <TableCell>
