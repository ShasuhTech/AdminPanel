...
import {
  DeleteConfigsId,
  DeleteConfigsIdFee,
  DeleteConfigsIdPettyHead,
  GetConfigsListFee,
  GetConfigsListPettyHead,
} from "@/services/api";
...
const PettyHead = () => {
  ...
  const {
    ...
    const payload = { type: "PettyHead" };
    const res = await GetConfigsListPettyHead(payload);
    return res?.data;
  });
  ...
  const handleDelete = async (id) => {
    if (window.confirm("Are you sure you want to delete?")) {
      try {
        await DeleteConfigsIdPettyHead(id);
        classRefetch();
      } catch (error) {
          ...
          >
            <TableContainer>
              <Table aria-label="house table">
                <TableHead>
                  <TableRow>
                    <StyledTableCell align="center">Priority No</StyledTableCell>
                    <StyledTableCell align="left">Petty Head</StyledTableCell>
