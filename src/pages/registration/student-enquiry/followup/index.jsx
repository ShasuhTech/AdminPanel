  ...
  return (
    <div className="">
      <div sx={{ marginTop: "5rem" }} style={{ backgroundColor: "#fff" }}>
        <Grid container spacing={2} sx={{ py: 2, px: 2, alignItems: "center",justifyContent:'center' }}>
          <Grid item justifyContent={'center'} xs={12} sm={6} md={6}>
            <FormControl fullWidth>
              <InputLabel id="demo-simple-select-label">Selected Status</InputLabel>
              <Select
    ...
    <React.Fragment>
      ...
      >
        ...
        <StyledTableCell align="left" style={{ minWidth: "250px", gap: 2 }}>
          ...
          <Button sx={{ marginLeft: "10px" }} variant="outlined" color="secondary">
            Follow Up
          </Button>
        </StyledTableCell>
      </TableRow>
