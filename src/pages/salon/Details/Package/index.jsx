      ...
      <Table aria-label="collapsible table" className="">
        <TableHead>
          <TableRow style={{ fontWeight: "500", color: "#000" }}>
            ...
            <StyledTableCell align="right">Regular Amount</StyledTableCell>
            <StyledTableCell align="right">Tax Amount</StyledTableCell>
    ...
    <React.Fragment>
      ...
      >
        ...
        <StyledTableCell align="right" style={{ minWidth: "150px" }}>
          <Typography>{(row?.regularAmountInPaisa/100)}</Typography>
        </StyledTableCell>
        <StyledTableCell align="right" style={{ minWidth: "150px" }}>
          <Typography>{(row?.taxAmountInPaisa/100)}</Typography>
        </StyledTableCell>
        <StyledTableCell align="right" style={{ minWidth: "150px" }}>
          <Typography>{(row?.discountAmountInPaisa/100)}</Typography>
        </StyledTableCell>
        <StyledTableCell align="right" style={{ minWidth: "150px" }}>
          <Typography>{(row?.finalNetAmountInPaisa/100)}</Typography>
        </StyledTableCell>
