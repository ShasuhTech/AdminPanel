...
import {
  AddAccountType,
  AddDepartment,
  AddNatureOfAppointment,
  AddOccupation,
  GetAccountTypeId,
  updateAccountType,
  updateDepartment,
  updateNatureOfAppointment,
  updateOccupation,
} from "@/services/api";
...
const StaffNatureOfAppointmentModal = ({ open, handleClose, selectedItem }) => {
  ...
  const submitHandler = async () => {
    ...
    try {
      if (!selectedItem?._id) {
        const res = await AddNatureOfAppointment(payload);
        if (res?.success) {
          toast.success("Successfully Added...");
          handleClose();
        }
      } else {
        const res = await updateNatureOfAppointment({
          ...payload,
          id: selectedItem._id,
        });
        if (res?.success) {
...
export default StaffNatureOfAppointmentModal;
